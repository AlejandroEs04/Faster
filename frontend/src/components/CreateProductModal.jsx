...
const CreateProductModal = ({setModal, productModal}) => {
    ...
    return (
        <div className="absolute w-full flex justify-center p-14 bg-black h-screen bg-opacity-10 backdrop-blur-sm">
            <div className='absolute w-full sm:w-2/3 md:w-1/2 xl:w-1/3 bg-white shadow-lg p-5 rounded'>
